...
data=/data1/priyanshus/Displace2024_baseline/speaker_diarization/track2_cluster/data/displace2024_dev
nnet_dir=/data1/priyanshus/Displace2024_baseline/speaker_diarization/track2_cluster/exp_original_model/xvector_nnet_1a_tdnn_fbank
egs_dir=exp_original_model/xvector_nnet_1a/egs #where the examples for training the model will be stored
...
#Priyanshu-I have set frames-per-iter to 10000000 and num-repeats to 20. The model is slightly overfitting but this can be easily resolved by 
#reducing the number of iterations by reducing num-repeats and frames-per-iter
...
if [ $stage -le 5 ]; then
  ...
  relu-batchnorm-layer name=tdnn6 dim=512 input=stats ##changed the dimension to 512 from 128.
